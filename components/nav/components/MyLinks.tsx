...
export const MyLinks = () => {
  return (
    <div className={styles.links}>
      ...
      >
        <Link href="https://www.linkedin.com/in/medisetti-sesha-venkata-rama-krishna-453b60286/" target="_blank" rel="nofollow">
      ...
      >
        <Link href="https://github.com/chakri6303" target="_blank" rel="nofollow">
